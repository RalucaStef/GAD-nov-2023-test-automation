...
public class SignUpPage {
    ...
    public void registerNewUser(String userName, String password, String confirmPassword, String gender,
            String firstName, String lastName, String email, String dateOfBirth,
            String nationality, boolean isTermsAndConditionsChecked) {
    ...
    public boolean checkErr(String expectedErr, String errorType) {
        switch (errorType) {
            ...
            case "email":
                ...
                System.out.println(
                        "TEST" + SeleniumUtils.isEmailValid(email) + "email: " + emailInput.getAttribute("value"));
